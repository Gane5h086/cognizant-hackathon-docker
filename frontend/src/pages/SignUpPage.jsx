    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case "confirmPassword":
                ...
                break;
            case "organization":
                if (!value.trim()) message = "Organization is required.";
                break;
            case "agree":
                if (!value) message = "You must agree to the Terms and Privacy Policy.";
                break;
            default:
                break;
        }
                    ...
                    <div className="p-8 order-2 lg:order-1">
                        ...
                        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-start">
                                ...
                                <label htmlFor="agree" className="ml-3 text-sm font-medium text-gray-700">
                                    I agree to the <a href="#" className="text-primary hover:underline">Terms and Privacy Policy</a>.
                                </label>
                            </div>
